...
(fact "nil url is not alive" (wfs/wfs-is-alive? nil nil nil) => falsey)
(fact "blank url is not alive" (wfs/wfs-is-alive? "" nil nil) => falsey)
(fact "invalid krysp wfs url is not alive" (wfs/wfs-is-alive? "invalid_url" nil nil) => falsey)
(fact "local test krysp wfs url is alive" (wfs/wfs-is-alive? local-wfs nil nil) => true)
(fact "local private test krysp wfs url without credentials is not alive" (wfs/wfs-is-alive? local-private-wfs nil nil) => falsey)
