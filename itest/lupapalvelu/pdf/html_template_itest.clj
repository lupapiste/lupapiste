(ns lupapalvelu.pdf.html-template-itest
  (:require [clojure.java.io :as io]
            ...
            [lupapalvelu.inspection-summary :refer [InspectionSummary] :as inspection-summary]
  ...
  (facts "inspection summary pdf generation at muuntaja"
    (let [app  {:primaryOperation     {:id "..op-id..", :name "pientalo-laaj", :description nil}
      ...
      (facts "pdf contents"
        ...
        (with-open [is (inspection-summary/create-inspection-summary-pdf app "en" "..summary-id..")]
