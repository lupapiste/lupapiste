LUPAPISTE.ApplicationGuestsModel = function() {
  ...
  self.isAuthority = self.disposedPureComputed( _.partial( hasAuth,
  ...
  self.guestAuthorities = self.disposedPureComputed( function() {
  ...
  self.error = self.disposedPureComputed( function() {
  ...
  self.sendEnabled = self.disposedPureComputed( function() {
  ...
  self.show = {
    subscribeColumn: self.disposedPureComputed( function() {
      return _.find( self.allGuests(), self.canSubscribe );
    }),
    inviteTable: self.disposedPureComputed( function() {
      return self.guestAuthorities().length;
    }),
    inviteMessage: self.disposedPureComputed( function() {
      return !self.isAuthority() || self.guestAuthorities().length;
    }),
    mandatory: self.disposedPureComputed( _.negate( self.sendEnabled) )
  };
