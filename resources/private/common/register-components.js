jQuery(document).ready(function() {
  ...
  var components = [
    ...
    {name: "docgen-property-list", synchronous: true},
    ...
    {name: "cell-text"},
    {name: "cell-span"},
    {name: "cell-textarea", model: "cell-text-model"},
    {name: "cell-date"},
    {name: "cell-select"},
    {name: "review-tasks"},
    {name: "task"},
    ...
    {name: "organization-person-list"},
    {name: "organization-report-form"},
    {name: "review-officer-dropdown"},
    {name: "docgen-review-officer-dropdown"},
    {name: "multi-attachment-edit-dialog"},
    {name: "simple-autocomplete"},
    {name: "docgen-autocomplete"},
    {name: "allu-application-kind"},
    {name: "docgen-allu-application-kind"},
    {name: "dictionary"},
    {name: "notice-forms"},
    {name: "new-notice-form"},
    {name: "notice-form"},
    {name: "recipient-data-dialog"},
    {name: "foreman-assignments"},
    {name: "location-editor"},
    {name: "page-flip"},
    {name: "applications-view-select"},
    {name: "applications-map-view"},
    {name: "applications-map-marker-popup"},
    {name: "applications-map-toggles"},
    {name: "tag-toggles"},
    {name: "application-search-toggles"},
    {name: "operation-tree"},
    {name: "last-page-create-application"},
    {name: "last-page-add-operation"},
    {name: "last-page-digging-permit"},
    {name: "last-page-replace-operation"},
    {name: "side-panel-control"},
    {name: "ping"},
    {name: "neighborhood"},
    {name: "send-neighbor-email"},
    {name: "neighbor-status"},
    {name: "review-request"},
    {name: "review-request-summary"},
    {name: "warnings"},
    {name: "docgen-group-info"},
    {name: "card-button"},
    {name: "card-buttons"},
    ...
    {name: "summary-handlers"},
    {name: "summary-operations"},
    {name: "summary-subtype"},
    {name: "summary-tos-function"},
    {name: "summary-link-permits"},
    {name: "summary-links"},
    {name: "preamble-summary"},
    {name: "preamble-title"},
    {name: "custom-notification-dialog"},
    {name: "warranty"}
];
