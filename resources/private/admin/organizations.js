;(function() {
  ...
  function OrganizationsModel() {
    ...
    self.julkipanoTemplate = _.template("Osoite: <%= obj.url %>\n" +
        "Sähköposti: <%= obj['notification-email'] %>\n" +
        "Toimenpideteksti taustajärjestelmästä: <%= obj['descriptions-from-backend-system'] ? 'Kyllä' : 'Ei' %>");
