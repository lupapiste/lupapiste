 ...
 */
LUPAPISTE.RegistrationModel = function(commandName, afterSuccessFn, ks) {
  "use strict";
  ...
  var PlainModel = function(data, keys) {
    ...
    self.password.extend({required: true, validPassword: true});
    ...
    self.isRequired = util.isRequiredObservable;
    self.isNotValid = util.isNotValidObservable;
  };
  ...
  self.setVetumaData = function(data) {
    ...
    var d = {
      ...
      eidasId: data.eidasId ? data.eidasId : undefined,
      eidasFirstName: data.eidasFirstName ? data.eidasFirstName : undefined,
      eidasFamilyName: data.eidasFamilyName ? data.eidasFamilyName : undefined,
      eidasBirthDate: data.eidasBirthDate ? data.eidasBirthDate : undefined
    };
