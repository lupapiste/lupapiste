...
LUPAPISTE.RamService = function() {
  ...
  self.fetchRamMessage = function(attachmentId, messageObservable) {
    ajax.query("ram-disabled-message", params( {attachmentId: attachmentId,
                                                lang: loc.currentLanguage}))
      .success(function(res) {
        messageObservable( res.message );
      })
      .call();
  };
