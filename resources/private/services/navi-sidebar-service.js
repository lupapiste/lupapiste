...
LUPAPISTE.NaviSidebarService = function(orgId) {
  "use strict";
  var self = this;
  ...
  self.title = ko.pureComputed(function () {
    if (lupapisteApp.usagePurpose().type === "authority-admin") {
      var orgNames = lupapisteApp.models.currentUser.orgNames();
      return orgNames ? orgId + " " + util.getIn(orgNames, [orgId, loc.currentLanguage]) : orgId;
    } else {
      return undefined;
    }
  });
  ...
  function someAuthOk( actions ) {
      return function() {
          return _.some( actions, lupapisteApp.models.globalAuthModel.ok);
      };
  }
  ...
  var menus = {
    authorityAdmin: [{icon: "lupicon-user",
                     ...
                     {icon: "lupicon-envelope",
                      page: "automatic-emails",
                      loc: "auth-admin.automatic-emails",
                      showIf: authOk("get-organization-automatic-email-templates")},
                     {icon: "lupicon-hammer",
                      page: "operations",
                     ...
                     {icon: "lupicon-shopping-cart",
                      ...
                      showIf: authOk( "organization-price-catalogues")},
                     {icon: "lupicon-link",
                      page: "backends",
                      loc: "auth-admin.backends"},
                     {icon: "lupicon-zoom-in-area",
                      page: "reviews",
                      loc: "auth-admin.reviews"},
                     ...
                     {icon: "lupicon-archives",
                      ...
                      loc:  "auth-admin.docterminal.settings",
                      showIf: someAuthOk(["docterminal-enabled", "docdepartmental-enabled"])},
                     {icon: "lupicon-log-in",
