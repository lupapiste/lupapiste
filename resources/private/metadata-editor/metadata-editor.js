(function() {
  ...
  function MetadataEditorModel(params) {
    ...
    self.save = function() {
      ...
      ajax.command(saveCommand, {id: self.applicationId, attachmentId: self.attachmentId, metadata: metadata})
        .success(function(data) {
    ...
    self.typeId = function( typeText ) {
      return self.attachmentId + "-" + typeText;
    };
  }
