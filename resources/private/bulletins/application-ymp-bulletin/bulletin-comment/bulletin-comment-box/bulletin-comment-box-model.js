LUPAPISTE.BulletinCommentBoxModel = function(params) {
  ...
  // This is the only option for users that use eIDAS authentication, because eIDAS does not automatically provide an address
  ...
  self.isSubmitDisabled = ko.pureComputed(function() {
    ...
    return isPending || !self.basicCommentFields.comment() || !self.basicCommentFields.email.isValid() || !allOtherInfoIsValid || (self.userInfo.eidasId() !== "" && !self.otherReceiver());
  });
