(function() {
  ...
  function Model() {
    ...
    self.remove = function(neighbor) {
      hub.send( "show-dialog", {ltitle: "neighbors.remove-dialog.title",
                                size: "medium",
                                component: "yes-no-dialog",
                                componentParams: {
                                  text: loc( "neighbors.remove-dialog.message",
                                             util.nonBlankJoin( [util.prop.toHumanFormat(  neighbor.propertyId ),
                                                                 _.get( neighbor, "owner.name")],
                                                                " ")),
                                  yesFn: _.wrap( neighbor, self.removeNeighbor )}});
    };
