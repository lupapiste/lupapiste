LUPAPISTE.NeighborsOwnersModel = function(params) {
  "use strict";
  var self = this;
  ...
  params.submitEnabled(self.submitEnabled());

  self.submitEnabled.subscribe(function(val) {
...
(function() {
  ...
  $(function() {
    ...
    ko.components.register("neighbors-owners", {
      viewModel: LUPAPISTE[_.capitalize(_.camelCase("neighbors-owners")) + "Model"],
      template: { element: "neighbors-owners" + "-template"}
    });
  });
