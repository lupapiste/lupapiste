...
(def ui-components
  {;; 3rd party libs
   ...
   :attachment   {:depends [:common-html :repository :signing :side-panel]
                  :js ["attachment-multi-select.js" "targeted-attachments-model.js" "attachment-utils.js" "attachment.js" "attachmentTypeSelect.js" "move-attachment-to-backing-system.js" ]
