  ...
  {;; 3rd party libs
   ...
   :bulletins {:depends [:ui-components :map :docgen]
               :html ["header.html" "footer.html"
                      ...
                      "application-bulletin/tab-templates/application-bulletin-attachments-tab-template.html"
                      "application-bulletin/bulletin-comment/bulletin-comment-box/bulletin-comment-box-template.html"
                      "application-bulletin/bulletin-attachments/bulletin-attachments-template.html"
               ...
               :js ["header.js"
                    ...
                    "application-bulletin/bulletin-attachments/bulletin-attachments-model.js"
