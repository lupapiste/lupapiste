...
(def- common-rakval-schemas ["hankkeen-kuvaus" "paatoksen-toimitus" "maksaja" "rakennuspaikka" "paasuunnittelija" "suunnittelija"])
...
(def operations
  (merge
    {:asuinrakennus               {:schema "uusiRakennus"
                                   ...
                                   :link-permit-required false
                                   :link-permit-verdict-required false} ;TODO old op-tree, remove later
