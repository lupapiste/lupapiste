...
(defn all-operations []
  (->> (vector operations-for-R
         (when (env/feature? :poikkari) operations-for-P)
         (when (env/feature? :ymparisto) operations-for-Y)
         (when (env/feature? :yleiset-alueet) operations-for-YA)) (keep :tree) (map first)))

;; TODO: implement
(defn municipality-operations [municipality] (all-operations))

;; TODO: implement
(defn organization-operations [organization-id] (all-operations))
