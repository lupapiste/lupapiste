...
(def operation->initial-schema-names
  {:asuinrakennus (concat common-schemas ["paasuunnittelija" "suunnittelija" "uusiRakennus"])
   ...
   :laajentaminen common-schemas (concat common-schemas ["paasuunnittelija" "suunnittelija" "uusiRakennus"])
