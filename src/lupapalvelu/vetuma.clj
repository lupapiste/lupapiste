...
(def ^String encoding "ISO-8859-1")
...
(defn- keys-as-keywords [m] (keys-as #(keyword (.toLowerCase ^String %)) m))
...
(defn mac [^String data] (.toUpperCase ^String (pandect/sha256 (.getBytes data encoding))))
