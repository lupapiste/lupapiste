...
(def default-authz-writer-roles #{:owner :writer :financialAuthority})
...
(def all-org-authz-roles (conj reader-org-authz-roles :authorityAdmin :tos-editor :tos-publisher :archivist :digitizer :financialAuthority))
