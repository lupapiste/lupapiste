...
(defn get-local-application-xml-by-filename [filename permit-type]
  (->> (str "./data/" filename) slurp sxml/parse scr/strip-xml-namespaces (not-empty-content permit-type)))
