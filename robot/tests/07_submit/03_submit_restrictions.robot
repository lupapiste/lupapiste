...
Applied submit restriction is visible on required field summary tab
  Open tab  requiredFieldSummary
  Wait until  Checkbox should be selected  optionSubmitRestrictionForOtherAuths

Erkki disables submit restriction
  Click label  optionSubmitRestrictionForOtherAuths
  Wait until  Checkbox should not be selected  optionSubmitRestrictionForOtherAuths
  Reload page
  Wait until  Checkbox should not be selected  optionSubmitRestrictionForOtherAuths
