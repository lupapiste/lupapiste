...
Mikko changes primary operation
  ...
  Wait Until  Element Should Be Visble  replace-operation
  ...
  Wait and click  //section[@id="replace-operation"]//button[@data-test-id="change-application-primary-operation"]
