...
Add post-verdict attachment
  ...
  Wait until  Element should not be visible  xpath=//export-attachments//button[@data-test-id='export-attachments-to-backing-system']
  ...
  Wait until  Element should be visible  xpath=//export-attachments//button[@data-test-id='export-attachments-to-backing-system']
