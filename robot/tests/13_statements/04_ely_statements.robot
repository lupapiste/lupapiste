...
Sonja sets up application by filling person details and submitting
  ...
  Select From List by label  xpath=//section[@data-doc-type='hakija-r']//select[@data-test-id='henkilo.userId']  Sibbo Sonja
  Sleep  0.5s
  Open accordions  parties
  Input text with jQuery  section[data-doc-type='hakija-r'] input[data-docgen-path='henkilo.henkilotiedot.hetu']  250876-8620
  Open accordions  parties
  Sleep  0.5s
  Select From List by label  xpath=//section[@data-doc-type='maksaja']//select[@data-test-id='henkilo.userId']  Sibbo Sonja
  Sleep  0.5s
  Open accordions  parties
...
Sonja statement to ELY
  ...
  Select from list by label  ely-subtypes  Lausuntopyyntö rakennuslupahakemuksesta
...
Optional due date must be in the future
  Test id OK  ely-maaraaika
  Test id enabled  bubble-dialog-ok
  Set maaraaika-datepicker field value  ely-maaraaika  1.8.2021
  Test id invalid  ely-maaraaika
  Test id disabled  bubble-dialog-ok
