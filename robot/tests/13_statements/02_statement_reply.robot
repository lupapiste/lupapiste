...
Olli requests for five statements
  ...
  Invite read-only statement giver  olli.uleaborg@ouka.fi  01.06.2018
  ...
  Invite read-only statement giver  olli.uleaborg@ouka.fi  02.06.2018
  Invite read-only statement giver  olli.uleaborg@ouka.fi  12.06.2018
  Invite read-only statement giver  olli.uleaborg@ouka.fi  22.06.2018
  Invite read-only statement giver  veikko.viranomainen@tampere.fi  03.06.2018
