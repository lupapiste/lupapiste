...
Pena doesn't see anything in statements tab
  Open tab  statement
...
Pena gives reply
  ...
  Wait until  Element should contain  xpath=//section[@id='statement']//div[@id='statement-reply-cover-note']/p  Pistäppä vastaten
