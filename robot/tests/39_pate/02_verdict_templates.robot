...
Edit template name: cancel
  ...
  Test id input is  template-name-input  ${EMPTY}
...
Fill and publish template
  ...
  Click enabled by test id  publish-template
  Wait Until Element Contains  //*[@data-test-id='template-state']  Julkaistu
