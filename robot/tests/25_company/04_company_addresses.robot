...
Building owners address is contact address
  ...
  Open accordions  info
  Execute Javascript  $("input[value='yritys']").click();
  Select From List  //section[@data-doc-type="uusiRakennus"]//select[@name="company-select"]  Valitse...
  Select From List  //section[@data-doc-type="uusiRakennus"]//select[@name="company-select"]  Solita Oy (1060155-5)
...
Applicant address is contact address
  ...
  Open accordions  parties
  Execute Javascript  $("input[value='yritys']").click();
  Select From List  //section[@data-doc-type="hakija-r"]//select[@name="company-select"]  Valitse...
  Select From List  //section[@data-doc-type="hakija-r"]//select[@name="company-select"]  Solita Oy (1060155-5)
