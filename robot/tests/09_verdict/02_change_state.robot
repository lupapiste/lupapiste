...
Select no longer contains verdictGiven
  Wait until  Page Should Not Contain Element  jquery=[data-test-id=change-state-select] option[value=verdictGiven]
  Wait until  Page Should Contain Element  jquery=[data-test-id=change-state-select] option[value=appealed]
