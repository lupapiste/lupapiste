...
Dangerous add
  ...
  Click enabled by test id  vaarallisetJatteet-append-button
...
Dig reload
  Reload page
  Wait until  Element should be visible by test id  laajennettuRakennusjateselvitys-accordion-title-text
  Kill dev-box
  Scroll to test id  sum-kaivettavaMaa-ainekset-hyodynnetaan
