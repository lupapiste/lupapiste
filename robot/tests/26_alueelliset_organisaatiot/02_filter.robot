...
...adds text into search field
  Input text by test id  text-filter-field  Pilvilinna

...chooses a handler role filter
...
...filter setup should be shown as default
  ...
  Textfield value should be  xpath=//input[@data-test-id="text-filter-field"]  Pilvilinna
  Element should be visible  xpath=//button[@data-test-id="user-handler-role-true" and @class="radio-button toggled"]
...
Sonja removes all but operations filter
  ...
  Input text by test id  text-filter-field  ${EMPTY}
  Filter item should contain X number of tags  areas  0
  Filter item should contain X number of tags  tags  0
  Filter item should contain X number of tags  operations  1
  Filter item should contain X number of tags  organization  0
...
Filter should be set as before visiting application
  ...
  Filter item should contain X number of tags  operations  1
  Filter item should contain X number of tags  organization  0
  Textfield value should be  xpath=//input[@data-test-id="text-filter-field"]  ${EMPTY}
  Element should not be visible  xpath=//button[@data-test-id="user-handler-role-true" and @class="radio-button toggled"]
  Sorting Should Be Set As Ascending  Tyyppi
