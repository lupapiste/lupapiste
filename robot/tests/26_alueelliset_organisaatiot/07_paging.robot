...
Teppo navigates to application page
  ...
  Wait until  Xpath Should Match X Times  //table[@id="applications-list"]//tbody/tr[contains(@class, 'application-row')]  13

Teppo selects 10 as the paging limit
  Click by test id  limit-10
  Wait until  Xpath Should Match X Times  //table[@id="applications-list"]//tbody/tr[contains(@class, 'application-row')]  10
