...
Mikko sees all "not needed" checkboxes as enabled and not selected
  [Tags]  attachments
  Wait until  Element Text Should Be  jquery=div#application-attachments-tab rollup[data-test-level=accordion-level-0]:first span.rollup-status__text  HAKEMUKSEN LIITTEET
