...
def createFile(path, content, mode='wb'):
    if not os.path.isfile(path):
        fp = open(path, mode)
        fp.write(content)
        fp.close()

TXT_TESTFILE_NAME = 'robotframework-testfile-06_attachments_TXT.txt'
PDF_TESTFILE_NAME = 'robotframework-testfile-06_attachments_PDF.pdf'
...
PNG_TESTFILE_NAME = 'robotframework-testfile-06_attachments_PNG.png'
...
TXT_CONVERTED_NAME = 'robotframework-testfile-06_attachments_TXT.pdf'
PNG_CONVERTED_NAME = 'robotframework-testfile-06_attachments_PNG.pdf'
...
XML_TESTFILE_NAME = 'robotframework-testfile-06_attachments_XML.xml'
...
createFile(TXT_TESTFILE_PATH, TXT_TESTFILE_CONTENT, 'w')
createFile(PNG_TESTFILE_PATH, PNG_TESTFILE_CONTENT)
createFile(PDF_TESTFILE_PATH, PDF_TESTFILE_CONTENT)
createFile(XML_TESTFILE_PATH, XML_TESTFILE_CONTENT, 'w')
