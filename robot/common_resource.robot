...
Create inforequest the fast way
  ...
  Go to  ${CREATE URL}?infoRequest=true&address=${address}&propertyId=${propertyId}&municipality=${municipality}&operation=${operation}&x=360603.153&y=6734222.95&message=${message}
