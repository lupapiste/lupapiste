...
(testable-privates lupapalvelu.operations applicant-doc-schema-name-YA)
...
(def application2 {:id               "LP-000-0000-0000"
                   :organization     "753-R"
                   :tosFunction      "10 03 00 01"
                   :primaryOperation {:id (mongo/create-id)
                   ...
                   :history          [{:state "draft"
                                      ...
                                      {:state "open"
                                       ...
                                       :user  {:firstName "Testi"
                                               :lastName  "Testaaja"}}]
                   :documents        [{:schema-info {:name applicant-doc-schema-name-YA
                                                     :subtype "hakija"}
                                       :data        {:henkilo {:henkilotiedot {:etunimi  {:value "Testaaja"}
                                                                               :sukunimi {:value "Testi"}}}
...
(fact "get-document-data"
  (get-in-document-data application2
                        (keyword applicant-doc-schema-name-YA) [:henkilo]) => {:henkilotiedot {:etunimi  {:value "Testaaja"}
                                                                                                 :sukunimi {:value "Testi"}}})
