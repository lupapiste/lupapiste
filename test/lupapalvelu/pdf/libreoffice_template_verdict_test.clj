...
(facts "Verdict vastuuhenkil\u00f6 "
       ...
       (fact {:midje/description " yritys "}
         (get-vastuuhenkilo (assoc application2 :documents [{:schema-info {:name :tyomaastaVastaava :subtype "tyomaasta-vastaava"}
       ...
       (fact {:midje/description " henkilo "}
             (get-vastuuhenkilo (assoc application2 :documents [{:schema-info {:name :tyomaasta-vastaava-optional :subtype "tyomaasta-vastaava"}
