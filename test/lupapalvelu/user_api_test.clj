...
(facts "add-user-attachment-allowed?"
  ...
  (fact "authority"
    (add-user-attachment-allowed? authority-user-data) => truthy)
  (fact "dummy"
    (add-user-attachment-allowed? {:role "dummy"}) => falsey)
  (fact "docstore-user"
    (add-user-attachment-allowed? {:role "docstore-api"}) => falsey))
