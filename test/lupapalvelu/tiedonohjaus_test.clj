    ...
    (fact "case file report data is generated from application"
      (generate-case-file-data application :fi) => [{:action    "Valmisteilla"
                                                    ...
                                                    {:action (i18n/localize :fi "caseFile.complementNeeded")
                                                     ...
                                                     :documents [{:category :handler-change, :ts 1462060800000, :text "Sibbo Sonja", :user "Hepokatti Heikki", :handler {:id 123, :roleId 456, :userId 789, :firstName "Sonja", :lastName "Sibbo"}}]}]
      (provided
