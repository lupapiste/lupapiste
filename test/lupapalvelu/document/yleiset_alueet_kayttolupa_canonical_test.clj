...
;        hakija-Vastuuhenkilo-osoite (-> hakija-Vastuuhenkilo :osoitetieto :osoite) => truthy
    ...
    (fact "Kasittelytieto-muutosHetki" (:muutosHetki Kasittelytieto) => (date/xml-datetime (:modified kayttolupa-application)))
    ...
    (fact "Kasittelytieto-paivaysPvm" (:paivaysPvm Kasittelytieto) => (date/xml-date (:opened kayttolupa-application)))
