...
(defn check-jatkoaika [jatkoaika-application jatkoaika-key]
  (facts* "Jatkoaika canonical model is correct"
          (let [canonical (jatkoaika-to-canonical jatkoaika-application "fi")
            ...
            (fact "Kasittelytieto-muutosHetki" (:muutosHetki Kasittelytieto) => (date/xml-datetime (:modified jatkoaika-application)))
            ...
            (fact "Kasittelytieto-paivaysPvm" (:paivaysPvm Kasittelytieto) => (date/xml-date (:opened jatkoaika-application)))
            ...
            (fact "Lisaaika-alkuPvm"
              alkuPvm => (date/xml-date "28.12.2013"))
            (fact "Lisaaika-loppuPvm"
              loppuPvm => (date/xml-date "30.12.2013")))))
