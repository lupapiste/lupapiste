...
(def vapautus-vesijohdosta-ja-viemarista-hakemus-v2
  (ctc/add-ulkomainen-hetu-for-docs vapautus-vesijohdosta-ja-viemarista-hakemus))

(ctc/validate-all-documents vapautus-vesijohdosta-ja-viemarista-hakemus)
(ctc/validate-all-documents vapautus-vesijohdosta-ja-viemarista-hakemus-v2)
...
(fl/facts* "Vesijohto ja viemari"
  (let [canonical (vc/vapautus-canonical vapautus-vesijohdosta-ja-viemarista-hakemus "fi") => truthy
        ...
        _ (:muutosHetki Kasittelytieto) => (-> vapautus-vesijohdosta-ja-viemarista-hakemus
                                               :modified
                                               date/xml-datetime)
