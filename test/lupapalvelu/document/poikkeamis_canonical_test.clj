...
#_(def- paasuunnittelija {:id "523844e1da063788effc1c5d"
                                  :created 1379419361123
                                  :schema-info {:approvable true
...
#_(def- suunnittelija {:id "523844e1da063788effc1c5e"
                               :schema-info {:approvable true
                                             :name "suunnittelija"
                                             :removable true
                                             :repeating true
                               ...
                               :data {:henkilotiedot
                                      ...
                                      :osoite {:katu {:value "Paapankuja 12"}
                                               :postinumero {:value "10203"}
                                               :postitoimipaikannimi {:value "Piippola"}}
                                      :patevyys {:koulutusvalinta {:value "other"}, :koulutus {:value "El\u00e4m\u00e4n koulu"}
                                                 :valmistumisvuosi {:value "2010"}
...
#_(def- documents-for-laajennus [hakija
                                laajennus
                                hanke
                                maksaja
                                rakennuspaikka
