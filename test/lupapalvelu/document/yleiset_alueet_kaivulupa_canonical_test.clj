...
(def maksaja {:created 1372331179008,
              :data
...
(def hankkeen-kuvaus {:created 1372331179008,
                      :data
                      {:kayttotarkoitus {:modified 1372331214906, :value "Ojankaivuu."},
                       :sijoitusLuvanTunniste
                       {:modified 1372331243461, :value "LP-753-2013-00001"}},
...
(def application
  {:state "open",
   ...
   [{:state "requires_authority_action",
     ...
     :locked false,
     :latestVersion
     {:fileId "51cc1e7b23e74941fee4f516",
