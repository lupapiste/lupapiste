...
(def hakija {:id "51cc1cab23e74941fee4f498",
             ...
             :data {:_selected {:modified 1372342070624, :value "yritys"},
                    :henkilo {:henkilotiedot {:etunimi {:value "Pena"},
                    ...
                    :yritys {:liikeJaYhteisoTunnus {:modified 1372331320811, :value "2492773-2"},
                             :osoite {:katu {:value "Paapankuja 12"},
...
(def tyomaasta-vastaava {:id "51cc1cab23e74941fee4f496",
                         ...
                         :data {:_selected {:modified 1372342063565, :value "henkilo"},
                                :henkilo {:henkilotiedot {:etunimi {:modified 1372341939920, :value "Pena"},
                                ...
                                :yritys {:liikeJaYhteisoTunnus {:modified 1372331412694, :value "2492773-2"},
...
(def henkilo {:henkilotiedot {:etunimi {:modified 1372341693897, :value "MaksajaPena"},
...
(def yritys {:liikeJaYhteisoTunnus {:modified 1372331520985, :value "2492773-2"},
...
(def party-public-area {:id "51cc1cab23e74941fee4f499",
                        :created 1372331179008,
