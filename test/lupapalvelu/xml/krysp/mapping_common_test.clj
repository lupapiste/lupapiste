...
(def common-210 "http://www.paikkatietopalvelu.fi/gml/yhteiset http://www.paikkatietopalvelu.fi/gml/yhteiset/2.1.0/yhteiset.xsd\nhttp://www.opengis.net/gml http://schemas.opengis.net/gml/3.1.1/base/gml.xsd\n")
...
(facts "schemalocation"
  ...
  (fact "MAL 2.1.1"
    (schemalocation "ymparisto/maa_ainesluvat" "2.1.1")
    (str common-210 "http://www.paikkatietopalvelu.fi/gml/ymparisto/maa_ainesluvat http://www.paikkatietopalvelu.fi/gml/ymparisto/maa_ainesluvat/2.1.1/maaAinesluvat.xsd"))

  (fact "YI 2.1.1"
    (schemalocation "ymparisto/ilmoitukset" "2.1.1") =>
    (str common-210 "http://www.paikkatietopalvelu.fi/gml/ymparisto/ilmoitukset http://www.paikkatietopalvelu.fi/gml/ymparisto/ilmoitukset/2.1.1/ilmoitukset.xsd"))

  (fact "YL 1.1.1"
    (schemalocation "ymparisto/ymparistoluvat" "2.1.1") =>
    (str common-210 "http://www.paikkatietopalvelu.fi/gml/ymparisto/ymparistoluvat http://www.paikkatietopalvelu.fi/gml/ymparisto/ymparistoluvat/2.1.1/ymparistoluvat.xsd"))

  (fact "VVVL 2.1.1"
    (schemalocation "ymparisto/vesihuoltolaki" "2.1.1") =>
    (str common-210 "http://www.paikkatietopalvelu.fi/gml/ymparisto/vesihuoltolaki http://www.paikkatietopalvelu.fi/gml/ymparisto/vesihuoltolaki/2.1.1/vesihuoltolaki.xsd"))
  )
