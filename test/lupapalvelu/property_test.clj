  ...
  (facts "without mongo cache"
    ...
    (fact "KTJ enabled, requests would be sent to KTJKii WFS"
      ...
      (provided
        ...
        (property-info-from-wfs "24500301050006") => {:municipality "245test"} :times 1)))
  (facts "mongo with cache"
    ...
    (fact "mongo returns, no mongo/insert call"
      ...
      (provided
        ...
        (mongo/select-one :propertyMunicipalityCache {:propertyId "24500301050006"} [:municipality]) => {:municipality "245mongo"}
