...
(facts "apply-template"
  ...
  (against-background [(fetch-template "master.md" nil)      => "{{>header}}\n\n{{>body}}\n\n{{>footer}}"
                       ...
                       (find-resource "-html-wrap.html" false)  => nil
...
(facts "User language templates: test body"
       (fetch-template "body.md") => (contains "suomi")
       (fetch-template "body.md" "sv") => (contains "Svenska")
       (fetch-template "body.md" "fi") => (contains "suomi")
       (fetch-template "body.md" "cn") => (contains "suomi"))

(facts "User language templates: footer"
